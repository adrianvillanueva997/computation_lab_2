...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableWidget_Usuarios = QtWidgets.QTableWidget(self.tab)
        font = QtGui.QFont()
        font.setPointSize(14)
        self.tableWidget_Usuarios.setFont(font)
        ...
        self.gridLayout_5.addWidget(self.tableWidget_Usuarios, 2, 1, 1, 1)
        ...
        self.pushButton_Registrar_usuario_2 = QtWidgets.QPushButton(self.tab)
        font = QtGui.QFont()
        font.setPointSize(14)
        self.pushButton_Registrar_usuario_2.setFont(font)
        self.pushButton_Registrar_usuario_2.setObjectName("pushButton_Registrar_usuario_2")
        self.gridLayout_4.addWidget(self.pushButton_Registrar_usuario_2, 0, 0, 1, 1)
        self.pushButton_Eliminar_usuario_2 = QtWidgets.QPushButton(self.tab)
        font = QtGui.QFont()
        font.setPointSize(14)
        self.pushButton_Eliminar_usuario_2.setFont(font)
        self.pushButton_Eliminar_usuario_2.setObjectName("pushButton_Eliminar_usuario_2")
        self.gridLayout_4.addWidget(self.pushButton_Eliminar_usuario_2, 0, 2, 1, 1)
        self.pushButton_Modificar_usuario_2 = QtWidgets.QPushButton(self.tab)
        font = QtGui.QFont()
        font.setPointSize(14)
        self.pushButton_Modificar_usuario_2.setFont(font)
        self.pushButton_Modificar_usuario_2.setObjectName("pushButton_Modificar_usuario_2")
        self.gridLayout_4.addWidget(self.pushButton_Modificar_usuario_2, 0, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_Registrar_usuario_2.setText(_translate("MainWindow", "Registrar usuario"))
        self.pushButton_Eliminar_usuario_2.setText(_translate("MainWindow", "Eliminar/Activar usuario"))
        self.pushButton_Modificar_usuario_2.setText(_translate("MainWindow", "Modificar usuario"))
